  ...
  return (
    <div className="task">
      <form id={id.value}>
        ...
        <input className="task__completed" type="checkbox" name="task_completed" checked={completed.value} onChange={props.updateTask} onBlur={props.putTaskUpdate} />
        <input className="task__desc" type="text" name="task_desc" placeholder="..." value={desc.value} onChange={props.updateTask} onBlur={props.putTaskUpdate} />
